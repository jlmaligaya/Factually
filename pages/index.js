    ...
    return (
      <>
        ...
        <div className="flex justify-between items-center">
          {/* Settings icon */}
          <svg xmlns="http://www.w3.org/2000/svg" fill="gray" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-10 h-10">
          ...
          <div>
          <h1 className="mb-4 px-4 font-heading text-white dark:text-white md:text-3xl lg:text-5xl text-with-stroke">Welcome to <span className="animate-text bg-gradient-to-r from-red-800 via-blue-500 to-white bg-clip-text text-transparent text-5xl font-heading">Factually</span>, {session.user.firstName}</h1>
          </div>
          {/* Logout icon */}
          <svg xmlns="http://www.w3.org/2000/svg" fill="red" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-10 h-10">
