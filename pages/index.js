  ...
  if (status === 'authenticated') {
    return (
      <>
        ...
        <audio ref={backgroundMusicRef} src="" loop></audio>
        <div>
        <div className={`flex justify-between items-center pt-20 ${isFading ? 'fade-out' : ''}`}>
            ...
            <a href="#" onClick={signOut}>
              <div className="w-16 h-16 bg-white rounded-3xl flex items-center justify-center mb-4 ml-20">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#5A5A5A" className="w-10 h-10 transform hover:animate-spin">
