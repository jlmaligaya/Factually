...
const CompletionPage = ({
  ...
  return (
    <div className="h-1/8 flex w-1/2 flex-row items-center justify-center gap-8 rounded-xl border-8 bg-white p-8 font-medium shadow-lg">
      ...
      <div className="w-4/5">
        ...
        <div className="flex w-full justify-center gap-4">
          <button
            className="flex items-center justify-center rounded-md border-2 border-black bg-blue-500 p-3 font-boom text-white hover:bg-blue-600"
            onClick={resetGame}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            className={`flex items-center justify-center rounded-md border-2 border-black bg-yellow-300 p-3 font-boom text-white hover:bg-yellow-400`}
          ...
          <button
            className="flex items-center justify-center rounded-md border-2 border-black bg-green-500 p-3 font-boom text-white hover:bg-green-600"
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col justify-center ">
            {wrongTopics.map((topic, index) => (
              <div
                key={index}
                className="text-stroke m-1 w-full rounded-full border-2 border-red-600 bg-red-500 px-3 py-1 text-center font-ogoby text-2xl text-white"
              >
                {topic}
              </div>
            ))}
